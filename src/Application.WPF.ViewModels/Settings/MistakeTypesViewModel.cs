...
public partial class MistakeTypesViewModel : BaseViewModel
{
    ...
    public MistakeTypesViewModel(IJournalListService service, ISessionService session)
    {
        _service = service;
        _session = session;
    ...
    {
        var list = await _service.GetItemsAsync(userId, JournalListCategory.MistakeType);
